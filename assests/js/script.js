...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio | Ali Ben Jahlan";
...
var Tawk_API=Tawk_API||{}, Tawk_LoadStart=new Date();
  (function(){
    ...
    s1.async=true;
    s1.src='https://embed.tawk.to/65dee5359131ed19d972b3bc/1hnnaumrm';
    s1.charset='UTF-8';
...
// End of Tawk.to Live Chat
 ...
 $("#contact-form").submit(function (event) {
    ...
    event.preventDefault();
    emailjs.init({
        publicKey: "--Lbv1bBTs0BNDdkt",
      });
    console.log("form submitted");
    emailjs.sendForm('service_631gwjf', 'template_jivuwcl', '#contact-form')
